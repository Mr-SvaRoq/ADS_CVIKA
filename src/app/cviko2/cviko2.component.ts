...
export class Cviko2Component implements OnInit {
  ...
  dynamicProg(towns: number[]): number {
    ...
    // a ak chcem zistit idealne penalizaciu dalsieho mesta, tak prejdem vsetky mesta uz s najdenymi idealnymi penalmi a zistim, s akym mestom je najmensia penalizacia
